...
output_path_4 = "./outputs/output_4.txt"
text_4 = (
...
if __name__ == "__main__":
    ...
    # 固有表現の抽出
    # extract_entities(text_6, output_path_6, nlp)

    doc = nlp(
        "2024年のオリンピックはパリで開催される予定であり、"
        "多くの選手がフランスに集まることになる。"
        "昨年の東京オリンピックで金メダルを獲得した山田太郎も出場を目指している。"
    )
